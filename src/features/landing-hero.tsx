  ...
  return (
    <section className="pt-97.5 md:pt-39 lg:pt-39 px-6 md:px-15 lg:px-33 h-full">
      <div className="flex flex-col-reverse md:flex-col lg:flex-col items-center justify-center gap-4 md:gap-20 lg:gap-20">
        ...
        <div className="max-w-[1200px] w-full text-background hidden md:hidden lg:flex flex-col gap-4 ">
        ...
        <div className="max-w-[1200px] w-full h-min flex flex-col md:flex-row lg:flex-row items-center md:items-end lg:items-end md:justify-between lg:justify-between gap-9 md:gap-0 lg:gap-0 z-1 md:mt-68 lg:mt-0">
